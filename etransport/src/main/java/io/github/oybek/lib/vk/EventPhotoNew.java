...
public class EventPhotoNew implements Event {
  ...
  public EventPhotoNew() {}

  public EventPhotoNew(int groupId, Photo object) {
  ...
  public EventPhotoNew setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventPhotoNew setObject(Photo v) {
    this.object = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventPhotoNew)) return false;

    EventPhotoNew that = (EventPhotoNew) thatObj;
  ...
  public String toString() {
    return "EventPhotoNew{" + "groupId=" + this.groupId + ',' + "object=" + this.object + '}';
  }
}
