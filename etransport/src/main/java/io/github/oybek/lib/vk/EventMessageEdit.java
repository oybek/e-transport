...
public class EventMessageEdit implements Event {
  ...
  public Events what() {
    return Events.EVENT_MESSAGE_EDIT;
  }
  ...
  public EventMessageEdit(int groupId, Message object) {
  ...
  public EventMessageEdit setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventMessageEdit setObject(Message v) {
    this.object = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventMessageEdit)) return false;

    EventMessageEdit that = (EventMessageEdit) thatObj;
  ...
  public String toString() {
    return "EventMessageEdit{" + "groupId=" + this.groupId + ',' + "object=" + this.object + '}';
  }
}
