...
public class EventMessageNew implements Event {
  ...
  public Events what() {
    return Events.EVENT_MESSAGE_NEW;
  }
  ...
  public EventMessageNew() {}

  public EventMessageNew(int groupId, Message object) {
  ...
  public EventMessageNew setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventMessageNew setObject(Message v) {
    this.object = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventMessageNew)) return false;

    EventMessageNew that = (EventMessageNew) thatObj;

    return this.groupId == that.groupId && this.object.equals(that.object);
  }

  @Override
  public String toString() {
    return "EventMessageNew{" + "groupId=" + this.groupId + ',' + "object=" + this.object + '}';
  }
}
