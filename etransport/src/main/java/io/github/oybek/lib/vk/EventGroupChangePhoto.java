...
public class EventGroupChangePhoto implements Event {
  ...
  public Events what() {
    return Events.EVENT_GROUP_CHANGE_PHOTO;
  }
  ...
  public EventGroupChangePhoto() {}

  public EventGroupChangePhoto(int groupId, int userId, Photo photo) {
  ...
  public EventGroupChangePhoto setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventGroupChangePhoto setUserId(int v) {
    this.userId = v;
    return this;
  }
  ...
  public EventGroupChangePhoto setPhoto(Photo v) {
    this.photo = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventGroupChangePhoto)) return false;

    EventGroupChangePhoto that = (EventGroupChangePhoto) thatObj;
