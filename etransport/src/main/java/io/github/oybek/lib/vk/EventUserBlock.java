...
public class EventUserBlock implements Event {
  ...
  public Events what() {
    return Events.EVENT_USER_BLOCK;
  }
  ...
  public EventUserBlock() {}

  public EventUserBlock(int groupId, int adminId, int userId, long unblockDate, String comment) {
  ...
  public EventUserBlock setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventUserBlock setAdminId(int v) {
    this.adminId = v;
    return this;
  }
  ...
  public EventUserBlock setUserId(int v) {
    this.userId = v;
    return this;
  }
  ...
  public EventUserBlock setUnblockDate(long v) {
    this.unblockDate = v;
    return this;
  }
  ...
  public EventUserBlock setComment(String v) {
    this.comment = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventUserBlock)) return false;

    EventUserBlock that = (EventUserBlock) thatObj;

    return this.groupId == that.groupId
        && this.adminId == that.adminId
        && this.userId == that.userId
        && this.unblockDate == that.unblockDate
        && this.comment.equals(that.comment);
  }

  @Override
  public String toString() {
    return "EventUserBlock{"
        + "groupId="
        + this.groupId
        + ','
        + "adminId="
