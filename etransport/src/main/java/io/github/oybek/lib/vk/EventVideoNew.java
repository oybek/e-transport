...
public class EventVideoNew implements Event {
  ...
  public EventVideoNew() {}

  public EventVideoNew(int groupId, Video object) {
  ...
  public EventVideoNew setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventVideoNew setObject(Video v) {
    this.object = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventVideoNew)) return false;

    EventVideoNew that = (EventVideoNew) thatObj;
  ...
  public String toString() {
    return "EventVideoNew{" + "groupId=" + this.groupId + ',' + "object=" + this.object + '}';
  }
}
