...
public class EventGroupChangeSettings implements Event {
  ...
  public Events what() {
    return Events.EVENT_GROUP_CHANGE_SETTINGS;
  }
  ...
  public EventGroupChangeSettings() {}

  public EventGroupChangeSettings(int groupId, int userId) {
  ...
  public EventGroupChangeSettings setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventGroupChangeSettings setUserId(int v) {
    this.userId = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventGroupChangeSettings)) return false;

    EventGroupChangeSettings that = (EventGroupChangeSettings) thatObj;

    return this.groupId == that.groupId && this.userId == that.userId;
  }

  @Override
  public String toString() {
    return "EventGroupChangeSettings{"
        + "groupId="
        + this.groupId
        + ','
        + "userId="
