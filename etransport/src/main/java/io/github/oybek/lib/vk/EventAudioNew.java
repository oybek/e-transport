...
public class EventAudioNew implements Event {
  ...
  public EventAudioNew() {}

  public EventAudioNew(int groupId, Audio object) {
  ...
  public EventAudioNew setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventAudioNew setObject(Audio v) {
    this.object = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventAudioNew)) return false;

    EventAudioNew that = (EventAudioNew) thatObj;
  ...
  public String toString() {
    return "EventAudioNew{" + "groupId=" + this.groupId + ',' + "object=" + this.object + '}';
  }
}
