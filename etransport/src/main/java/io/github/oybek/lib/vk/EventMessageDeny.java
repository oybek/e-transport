...
public class EventMessageDeny implements Event {
  ...
  public Events what() {
    return Events.EVENT_MESSAGE_DENY;
  }
  ...
  public EventMessageDeny() {}

  public EventMessageDeny(int groupId, int userId) {
  ...
  public EventMessageDeny setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventMessageDeny setUserId(int v) {
    this.userId = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventMessageDeny)) return false;

    EventMessageDeny that = (EventMessageDeny) thatObj;
  ...
  public String toString() {
    return "EventMessageDeny{" + "groupId=" + this.groupId + ',' + "userId=" + this.userId + '}';
  }
}
