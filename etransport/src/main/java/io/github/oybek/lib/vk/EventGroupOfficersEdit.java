...
public class EventGroupOfficersEdit implements Event {
  ...
  public Events what() {
    return Events.EVENT_GROUP_OFFICERS_EDIT;
  }
  ...
  public EventGroupOfficersEdit() {}

  public EventGroupOfficersEdit(int groupId, int adminId, int userId) {
  ...
  public EventGroupOfficersEdit setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventGroupOfficersEdit setAdminId(int v) {
    this.adminId = v;
    return this;
  }
  ...
  public EventGroupOfficersEdit setUserId(int v) {
    this.userId = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventGroupOfficersEdit)) return false;

    EventGroupOfficersEdit that = (EventGroupOfficersEdit) thatObj;
