...
public class EventGroupJoin implements Event {
  ...
  public Events what() {
    return Events.EVENT_GROUP_JOIN;
  }
  ...
  public EventGroupJoin() {}

  public EventGroupJoin(int groupId, int userId) {
  ...
  public EventGroupJoin setGroupId(int v) {
    this.groupId = v;
    return this;
  }
  ...
  public EventGroupJoin setUserId(int v) {
    this.userId = v;
    return this;
  }
  ...
  public boolean equals(Object thatObj) {
    ...
    if (!(thatObj instanceof EventGroupJoin)) return false;

    EventGroupJoin that = (EventGroupJoin) thatObj;
  ...
  public String toString() {
    return "EventGroupJoin{" + "groupId=" + this.groupId + ',' + "userId=" + this.userId + '}';
  }
}
